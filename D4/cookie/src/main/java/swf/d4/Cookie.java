...
public class Cookie {
     ...
     * cookies.
     * add("Poetry is just the evidence of life. If your life is burning well, poetry is just the ash."
     * );
     * cookies.
     * add("Do not try to solve all life's problems at once ― learn to dread each day as it comes."
     * );
     * cookies.add("Vodka mixes well with everything, except decisions.");
     * cookies.
     * add("Never make the same mistake twice. There are so many new ones. Try a different one each day."
     * );
     * cookies.
     * add("I don't hold grudges. I hold memories that keep me better prepared for our next encounter."
     * );
     * cookies.add("The planet is fine. The people are fucked.");
     * cookies.add("If a book about failures doesn't sell, is it a success?");
     * cookies.
     * add("A word to the wise ain't necessary, it's the stupid ones who need advice."
     * );
     * cookies.add("If you're too open-minded; your brains will fall out.");
     * cookies.
     * add("Life is pleasant. Death is peaceful. It's the transition that's troublesome."
     * );
     * cookies.add("The funniest people are the saddest ones.");
     * cookies.
     * add("Never trust people who smile constantly. They're either selling something or not very bright."
     * );
     * cookies.add("How is it possible to have a civil war?");
     * cookies.
     * add("My congratulations to you, sir. Your manuscript is both good and original; but the part that is good is not original, and the part that is original is not good."
     * );
     * cookies.add("Rejection is an opportunity for your selection.");
     * cookies.
     * add("Pressure is something you feel when you don't know what the hell you're doing."
     * );
     * cookies.
